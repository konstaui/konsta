...
Tailwind Mobile loves to welcome your contributions. There are several ways to help out:

- Create an [issue](https://github.com/tailwind-mobile/tailwind-mobile/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/tailwind-mobile/tailwind-mobile/issues), assuming one does not already exist.
