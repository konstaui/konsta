...
export const TableCellColors = (colorsProp = {}, dark) => {
  return {
    ...
    cellBorderIos: cls(
      'before:bg-black before:bg-opacity-20',
      dark('dark:before:bg-white dark:before:bg-opacity-15')
    ),
    cellBorderMaterial: cls(
      'before:bg-md-light-outline',
      dark('dark:before:bg-md-dark-outline')
    ),
    ...colorsProp,
  };
};
