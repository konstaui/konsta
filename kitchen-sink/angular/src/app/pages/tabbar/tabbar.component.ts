            ...
            <span icon [class.hidden]="!showIcons()">
              <k-icon [icon]="true" component="span">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M 16.5000 51.2773 L 39.5000 51.2773 C 45.2656 51.2773 48.2773 48.2656 48.2773 42.5234 L 48.2773 18.5234 C 48.2773 12.7578 45.2656 9.7695 39.5000 9.7695 L 16.5000 9.7695 C 10.7578 9.7695 7.7227 12.7578 7.7227 18.5234 L 7.7227 42.5234 C 7.7227 48.2656 10.7578 51.2773 16.5000 51.2773 Z M 16.6641 47.1250 C 13.2109 47.1250 11.8750 45.8359 11.8750 42.3125 L 11.8750 23.0586 L 44.1250 23.0586 L 44.1250 42.3125 C 44.1250 45.8359 42.8125 47.1250 39.3359 47.1250 Z M 19.8672 7.0664 L 21.1328 7.0664 L 21.1328 2.7227 L 19.8672 2.7227 Z M 34.8672 7.0664 L 36.1328 7.0664 L 36.1328 2.7227 L 34.8672 2.7227 Z" />
                </svg>
                <svg
                  material
                  class="w-6 h-6"
            ...
            <span icon [class.hidden]="!showIcons()">
              <k-icon [icon]="true" component="span">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M 18.5936 49.5742 L 37.4061 49.5742 C 43.6327 49.5742 46.6936 46.5133 46.6936 40.3336 L 46.6936 26.6445 C 46.6936 25.5898 46.4358 24.6289 45.9202 23.8555 C 47.4905 22.4961 48.3749 20.5508 48.3749 18.3242 C 48.3749 13.6367 44.8749 10.0195 40.1405 10.0195 C 39.6483 10.0195 39.1561 10.0664 38.6405 10.1836 C 37.4530 6.3789 33.9530 3.6914 29.7343 3.6914 C 27.5077 3.6914 25.5155 4.5055 23.9452 5.9586 C 22.7577 3.0820 20.2030 1.3008 17.0124 1.3008 C 12.7702 1.3008 9.4124 4.9414 9.4124 9.6055 C 9.4124 10.4664 9.5061 11.3039 9.6936 12.1414 C 5.9124 12.9320 3.0124 16.2195 3.0124 20.2273 C 3.0124 24.9617 6.5827 28.5320 11.2702 28.5320 L 11.5983 28.5320 C 10.7608 29.7898 10.3061 31.3836 10.3061 33.0742 L 10.3061 40.3336 C 10.3061 46.5133 13.3671 49.5742 18.5936 49.5742 Z M 29.7577 16.7117 C 30.5483 16.7117 31.1952 17.3586 31.1952 18.1492 L 31.1952 28.5320 L 33.0233 28.5320 C 33.9608 28.5320 34.3452 29.2117 33.8061 29.9617 L 29.0014 36.0711 C 28.5561 36.6570 27.9327 36.6570 27.4874 36.0711 L 22.7061 29.9617 C 22.1671 29.2117 22.5280 28.5320 23.4655 28.5320 L 25.3171 28.5320 L 25.3171 18.1492 C 25.3171 17.3586 25.9639 16.7117 26.7546 16.7117 Z" />
                </svg>
                <svg
                  material
                  class="w-6 h-6"
